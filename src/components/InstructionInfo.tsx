...
const instructions: Instruction[] = [
  ...
  { name: "ADDCI data", description: "Add immediate data and carry bit C to accumulator" },
  ...
  { name: "SUBBI data", description: "Subtract immediate data and carry bit C from accumulator" },
